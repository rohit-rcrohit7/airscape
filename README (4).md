...
### Reading the map
- **Hover/tap** anywhere to probe the estimated value at that point, named and banded (e.g. "NO₂ 28.4 µg/m³ · moderate").
- Select a **sampling point** to see its location context and a 48-hour trend sparkline.
